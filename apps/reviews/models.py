...
class Review(models.Model):
    class RatingChoice(models.IntegerChoices):
        ...
        four = 4
        five = 5
    user = models.ForeignKey(User,on_delete=models.CASCADE,related_name="user_review", verbose_name="Пользователь")
    product = models.ForeignKey(Product,on_delete=models.CASCADE,related_name="product_review", verbose_name="Продукт")
